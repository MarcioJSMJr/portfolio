...
export default async function AdminPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#f7f8fa] dark:bg-neutral-950 text-neutral-900 dark:text-neutral-100 px-5 py-8 sm:px-8 lg:px-10 xl:px-12 2xl:px-16 selection:bg-blue-500/30 transition-colors duration-200">
      <div
        aria-hidden
      ...
      <div className="mx-auto w-full max-w-none space-y-10">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-neutral-200/80 dark:border-neutral-800/80">
          ...
          <div className="flex items-center gap-2.5 flex-wrap">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-white/80 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 text-neutral-700 dark:text-neutral-300 shadow-sm">
        ...
        <header className="space-y-2">
          ...
          <p className="text-neutral-600 dark:text-neutral-400 text-sm sm:text-base font-light max-w-2xl">
